...
def create_corrected_prozesswaerme():
    """Create Prozesswärme structure following exact Gebäudewärme pattern"""
    
    # Based on Excel data analysis and Gebäudewärme structure pattern
    prozesswaerme_data = [
        ...
        {'code': '3.1.9', 'category': '=', 'unit': 'GWh/a', 'status': None, 'ziel': None, 'is_calculated': True},
        ...
        {'code': '3.2.9', 'category': '=', 'unit': 'GWh/a', 'status': None, 'ziel': None, 'is_calculated': True},
        ...
        # Level 4: Energy type breakdown (like 2.4, 2.5 for space heating/hot water)
        ...
        # Final total (like 2.10)
        {'code': '3.10', 'category': 'Endenergieverbrauch PW gesamt', 'unit': 'GWh/a', 'status': None, 'ziel': None, 'is_calculated': True},
    ]
    ...
    print(f"\nCreated {len(prozesswaerme_data)} corrected Prozesswärme entries")

if __name__ == "__main__":
    print("CORRECTING PROZESSWÄRME STRUCTURE TO MATCH GEBÄUDEWÄRME PATTERN")
    print("=" * 70)
    ...
    create_corrected_prozesswaerme()
    
    print("\nPROZESSWÄRME STRUCTURE CORRECTED!")